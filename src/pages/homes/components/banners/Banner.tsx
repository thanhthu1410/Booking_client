        ...
        <div className="banner_chirld_left">
          ...
          <div className="circle-spin">
            <div className="circle-logo">
              <img src="https://themeholy.com/html/rasm/demo/assets/img/icon/logo-icon.svg" alt="" />
            </div>
            <div className="circle-title">
              ...
              <span className="char12">c</span>
              <span className="char13">e</span>
              <span className="char14"> </span>
              <span className="char15">1</span>
              <span className="char16">9</span>
