    ...
    return (
        <>
            ...
            <div className={`modal__container ${open ? 'show' : ''}`}>
                ...
                {appointmentStore.notifications?.slice(appointmentStore.notifications.length - 10 > 0 ? appointmentStore.notifications.length - 10 : 0, appointmentStore.notifications.length).map((message) => {
